...
if (isset($_POST['student_login'])) {
    ...
    // echo $email;
    // echo $password;
    $res = $conn->query("SELECT * FROM teachers WHERE email = '$email' AND password = '$password'");
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="student-login.php" class="btn btn-dark float-end mx-3"> Students Login</a>
                        </h4>
                    </div>
